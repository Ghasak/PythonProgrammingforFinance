"""
    Machine learning with finance - Pattern Recognition for
        Algorithmic Forex and Stock Trading: Machine Learning and Pattern Recognition for Stocks and Forex Part 3
"""
...
if __name__ == "__main__":
    output1 = session_info("Machine Learning and Pattern Recognition for Stocks and Forex Part 3")
    output1.Initial_run()
    graphRaxFx()
